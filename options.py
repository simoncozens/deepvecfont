...
def get_parser_main_model():
    ...
    parser.add_argument(
        ...
        type=int,
        default=52,
        help="number of glyphs, original is 52",
    )
    ...
    parser.add_argument(
        "--out_channel", type=int, default=1, help="output image channel"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=128,
        help="image size, must be 2**n, 64 and 128 tested",
    )
    parser.add_argument(
        "--image_size_sr", type=int, default=256, help="image size for super resolution"
    )
    parser.add_argument(
        "--seq_feature_dim",
        type=int,
    ...
    parser.add_argument(
        "--ckpt_freq", type=int, default=25, help="save checkpoint frequency of epoch"
    )
    parser.add_argument(
        "--sample_freq", type=int, default=200, help="sample train output of steps"
    )
    parser.add_argument(
        "--val_freq", type=int, default=1000, help="sample validate output of steps"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="the sample times when testing",
    )
    parser.add_argument(
        "--nr_ckpt_num",
        type=int,
    ...
    parser.add_argument(
        "--cx_loss_w", type=float, default=0.1, help="the weight of contextual loss"
    )
    parser.add_argument(
        "--l1_loss_w",
        type=float,
    ...
    parser.add_argument(
        "--mdn_loss_w", type=float, default=1.0, help="the weight of mdn loss"
    )
    parser.add_argument(
        "--softmax_loss_w",
        type=float,
        default=1.0,
        help="the weight of softmax ce loss",
    )
    # neural rasterizer
    parser.add_argument(
        "--use_nr",
        type=bool,
        default=True,
        help="whether to use neural rasterization during training",
    )
    # LSTM related
    parser.add_argument(
        "--hidden_size", type=int, default=512, help="lstm encoder hidden_size"
    )
    parser.add_argument(
        "--num_hidden_layers",
        type=int,
        default=4,
        help="svg decoder number of hidden layers",
    )
    parser.add_argument(
        "--rec_dropout", type=float, default=0.3, help="LSTM rec dropout"
    )
    parser.add_argument(
        "--ff_dropout", type=float, default=0.5, help="LSTM feed forward dropout"
    )
    # MDN related
    ...
    # testing related
    parser.add_argument(
        "--test_epoch", type=int, default=125, help="the testing checkpoint"
    )
    parser.add_argument(
        "--test_fontid", type=int, default=0, help="the testing font id"
    )
